...
- **notebooks/** — All ETL notebooks for Bronze, Silver, and Gold, as well as sql for setting up the catalog and a python notebook for generating syntatic general orders data and writing in a volume. The notebooks are prefixed by according to the order of execution in the pipeline.
